...
class Ui_SettingWindow(object):
    ...
    def retranslateUi(self, SettingWindow):
        ...
        self.label.setText(_translate("SettingWindow", "User ID telegram"))
        self.label_2.setText(_translate("SettingWindow", "Bot token"))
        self.label_3.setText(_translate("SettingWindow", "IP Database"))
        self.label_4.setText(_translate("SettingWindow", "User Database"))
        self.label_5.setText(_translate("SettingWindow", "Password Database"))
